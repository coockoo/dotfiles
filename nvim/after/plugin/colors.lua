...
vim.api.nvim_set_hl(0, '@markup.raw.markdown_inline', { link = 'Comment' })
vim.api.nvim_set_hl(0, '@markup.link.url.markdown', { link = 'Underlined' })
vim.api.nvim_set_hl(0, '@markup.link.markdown_inline', { link = 'Float' })
vim.api.nvim_set_hl(0, '@markup.link.label.markdown_inline', { link = 'Float' })
vim.api.nvim_set_hl(0, '@markup.link.label.markdown', { link = 'Float' })
